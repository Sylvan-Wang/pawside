...
const requiredFiles = [
  ...
  'supabase/migrations/20260911000100_generate_cycle_session_prescriptions.sql',
  'supabase/migrations/20260911000200_method_workout_runtime.sql',
  'supabase/migrations/20260912000100_method_runtime_set_templates.sql',
  'supabase/migrations/20260924000100_method_runtime_reliability.sql',
  ...
  'supabase/migrations/20260926000200_onboarding_target_layer.sql',
  'supabase/migrations/20260926000300_recovery_feedback_targets.sql',
  'supabase/migrations/20260926000400_canonical_nutrition_runtime.sql',
  'supabase/migrations/20260926000500_profile_target_runtime.sql',
  'supabase/migrations/20260926000600_food_resolution_memory.sql',
  ...
  'supabase/tests/method_workout_runtime_contract.sql',
  'supabase/tests/method_runtime_set_templates_contract.sql',
  'supabase/tests/method_runtime_reliability_contract.sql',
  'supabase/tests/method_runtime_state_truth_contract.sql',
  'supabase/tests/training_date_navigation_contract.sql',
  'supabase/tests/minimum_p1_duration_contract.sql',
  'supabase/tests/training_runtime_truth_hardening_contract.sql',
  'supabase/tests/profile_target_runtime_contract.sql',
  'supabase/tests/canonical_nutrition_runtime_contract.sql',
  'supabase/tests/food_resolution_memory_contract.sql',
